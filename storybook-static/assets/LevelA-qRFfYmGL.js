import{j as n}from"./jsx-runtime-Dr09uJeB.js";import{useMDXComponents as l}from"./index-B-17l0hQ.js";import"./index-B_0np5cU.js";function s(i){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...l(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"level-a---analytical-model",children:"Level A - Analytical Model"}),`
...
`,n.jsxs(e.table,{children:[n.jsx(e.thead,{children:n.jsxs(e.tr,{children:[n.jsx(e.th,{children:"Region"}),n.jsx(e.th,{children:"Capacitance"})]})}),n.jsxs(e.tbody,{children:[n.jsxs(e.tr,{children:[n.jsx(e.td,{children:"Accumulation"}),n.jsx(e.td,{children:"C = C_ox"})]}),n.jsxs(e.tr,{children:[n.jsx(e.td,{children:"Depletion"}),n.jsx(e.td,{children:"C = C_ox × C_dep / (C_ox + C_dep)"})]}),n.jsxs(e.tr,{children:[n.jsx(e.td,{children:"Inversion"}),n.jsx(e.td,{children:"C = C_min (HF)"})]})]})]}),`
...
`]})]})}function d(i={}){const{wrapper:e}={...l(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(s,{...i})}):s(i)}export{d as default};
